    ...
    <>
      ...
      <main className="container">
        ...
        <section id="mission" className="mission-section">
          <h2>Our Mission</h2>
          <p>
            YourNephron empowers Californians with accessible kidney health education —
            tackling chronic kidney disease through awareness, prevention, and community outreach.
          </p>
        </section>
      </main>
